...
export default function SimpleCheckIn() {
  ...
  const validateCheckIn = () => {
    ...
    if (!photoFile || !photoValidated) {
      setError('La fotografía es obligatoria. Por favor toma y valida la foto.');
      return false;
    }
    if (!location) {
      ...
      <div className="max-w-md mx-auto p-4 space-y-6">
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
              ...
              <div className="space-y-3">
                <div className="relative">
                  <img
                    ...
                    className={`w-full h-48 object-cover rounded-lg border-2 ${photoValidated ? 'border-green-400' : 'border-yellow-300'}`}
                    onError={() => {
                ...
                {!photoValidated ? (
                  ...
                  <div className="space-y-2">
                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-center">
                      <p className="text-yellow-800 text-sm font-medium">Revisa la foto antes de continuar</p>
                      <p className="text-yellow-600 text-xs">Si se ve bien, presiona "Usar esta foto"</p>
                    </div>
                    <div className="flex space-x-2">
                      <button
                        type="button"
                      ...
                      <button
                        type="button"
                        onClick={() => setPhotoValidated(true)}
                        className="flex-1 bg-primary-600 text-white py-2 px-4 rounded-lg hover:bg-primary-700 text-sm font-semibold"
                      >
                        Usar esta foto
                      </button>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-center">
                      <p className="text-green-800 text-sm font-medium">Foto validada</p>
          ...
          <button
            ...
            disabled={submitting || !location || !photoFile || !photoValidated || !selectedProduct || !selectedKiosk || !checkInType}
